...
// 无向有权图和有向有权图
// 空间复杂度：O(V + E)
export class WeightedGraphImpl {
    // lines 表示图的信息，从外面传进来
